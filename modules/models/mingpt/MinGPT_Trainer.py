...
class MinGPT_Trainer(Trainer):
    ...
    def get_loaders(self,batch_size,num_workers=0):
        t_dataloader = DataLoader(self.train_dataset, batch_size=batch_size, shuffle=True, num_workers=num_workers)
        v_dataloader = DataLoader(self.valid_dataset, batch_size=batch_size, shuffle=True, num_workers=num_workers)
    ...
    def compute_loss(self, batch_data):
        ...
        token_in = self.model.forward(token_in).transpose(1,2) # (B, C, T)
