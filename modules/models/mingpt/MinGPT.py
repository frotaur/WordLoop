...
class MinGPT(ConfigModule):
    ...
    # We may need a 'from_pretrained' from huggingface eventually. Look at minGPT repo for inspiration
    ...
    def configure_optimizers(self, train_config):
        ...
        NOT USING THIS FOR NOW. MAY COME BACK LATER TO LOOK IN DETAIL WHAT IT IS, AND IF ITS USEFUL
        """
        pass
